...
// Import components
import { MuseumListHome, MuseumListDetail, MuseumListObject, MuseumListExhibition, MuseumListActivity, MuseumListNews, MuseumListComment} from './components/Museum/MuseumList';
import {
...
function MuseumListStackScreen({navigation, route}) {
  return (
    <Stack.Navigator headerMode="none">
      ...
      <Stack.Screen name="MuseumListComment" component={ MuseumListComment} navigation={navigation} route={route} />
    </Stack.Navigator>
  );
}
